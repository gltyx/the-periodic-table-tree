...
addLayer("Li", {
    ...
    automate() {
        ...
        if (player.Li.Gain.gte(1) && player.Li.Gain.lte(player.Li.Li1) && player.Li.Size == 2 && hasMilestone('Li', 5)) player.Li.points = player.Li.points.add(player.Li.HM.times(player.V.M)).add(player.Li.RM).add(player.V.M).times(player.Li.PM).times(player.Be.LB).times(player.Be.LB2)
